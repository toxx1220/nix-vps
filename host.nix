      ...
      // {
        "toxx.dev" = {
          extraConfig = ''
            ...
            # This directory contains the generated 'impressum.html' and 'datenschutz.html'.
            root * /run/impressum
    ...
    serviceConfig = {
      ...
      ExecStart = "${pkgs.writers.writeBash "generate-html-placeholders" { } (
        ...
        ''
          ...
          export OUTPUT_FILE=/run/impressum/impressum.html
          ${script} \
          ...
          export OUTPUT_FILE=/run/impressum/datenschutz.html
          ${script} \
            EMAIL_FILE="$EMAIL_FILE" \
            PHONE_FILE="$PHONE_FILE" \
            NAME_FILE="$NAME_FILE"
